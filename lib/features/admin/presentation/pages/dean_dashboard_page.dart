...
class DeanDashboardPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DeanDashboardPage> createState() => _DeanDashboardPageState();
}
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return StaffComplaintCard(
                          ...
                          onResolve: () {
                            ref.read(submitComplaintProvider.notifier).updateStatus(c.id, 'resolved', 'Final approval by Dean');
                          },
                          onReject: () {
                            ref.read(submitComplaintProvider.notifier).updateStatus(c.id, 'rejected', 'Rejected by Dean');
                          },
                        );
                      },
                    ),
